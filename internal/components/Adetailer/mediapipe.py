...
from internal.components.Adetailer.common import PredictOutput
from internal.components.Adetailer.common import create_bbox_from_mask, create_mask_from_bbox
...
) -> List[Image.Image]: #PredictOutput:
    import mediapipe as mp
