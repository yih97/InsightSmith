...
import internal.training_scripts.library.train_util as train_util
...
def main(args):
    ...
    def run_batch(path_imgs):
        ...
        for (image_path, _), prob in zip(path_imgs, probs):
            ...
            pre_fix_tag_text=ast.literal_eval(args.prefix_tags)
            combined_tags = [combined_tags.strip().strip("'") for combined_tags in pre_fix_tag_text]
            general_tag_text = ""
            character_tag_text = ""
...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--prefix_tags")
